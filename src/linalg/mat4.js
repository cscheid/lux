...
// from glMatrix
function asInverseTransposeMat3(mat)
{
...
exports.asInverseTransposeMat3 = asInverseTransposeMat3;
...
// from glMatrix
function translationOf(mat, vec)
{
  var result = new Float32Array(16);
  result.buffer._type = 'mat4';
  var x = vec[0], y = vec[1], z = vec[2];
...
exports.translationOf = translationOf;
...
exports.scalingOf = scalingOf;

function scaling(mat, vec)
{
  var result = new Float32Array(16);
  result[0] =  vec[0];
  result[5] =  vec[1];
...
// from glMatrix
function rotationOf(mat, angle, axis)
{
...
function rotate(mat, angle, axis)
{
  var x = axis[0], y = axis[1], z = axis[2];
  var len = Math.sqrt(x*x + y*y + z*z);
  if (!len) { throw new Error("zero-length axis"); }
