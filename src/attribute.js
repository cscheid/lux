/*
 * Lux.attribute creates the structures necessary for Lux to handle
 * per-vertex data.
 *
 ...
 * options:
 *
 *   array is the data array to be used. It must be one of the following
 *     datatypes:
 *
 ...
 *
 *   keepArray tells Lux.attribute to keep a copy of the buffer in
 ...
 *   var positionAttribute = Lux.attribute({
 ...
 *   var colorAttribute = Lux.attribute({
 *       array: [1,0,0,1, 1,1,0,1, 1,1,1,1],
 *       itemSize: 4,
