...
{
    // convert the string of typeface instructions coming from typeface.js glyph
...
// currently only left-justified ltr text. yeah, i know.
function string_batch(opts) {
    var old_opts = opts;
    if (opts.batch) {
        return opts.batch;
    }
